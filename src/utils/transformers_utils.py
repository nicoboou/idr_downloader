...
def download_weights(backbone_type, patch_size, pretrained_type):
    ...
    checkpoints_dinov2 = {
        "vit_small" : {14: "https://dl.fbaipublicfiles.com/dinov2/dinov2_vits14/dinov2_vits14_pretrain.pth"}, 
        "vit_base" : {14: "https://dl.fbaipublicfiles.com/dinov2/dinov2_vitb14/dinov2_vitb14_pretrain.pth"},
        "vit_large" : {14: "https://dl.fbaipublicfiles.com/dinov2/dinov2_vitl14/dinov2_vitl14_pretrain.pth"}
    }
...
def get_backbone_state_dict(state_dict, transformer=True):
